            ...
            <div className="max-w-7xl mx-auto space-y-20">
                ...
                >
                    <div className="space-y-4">
                        <h1 className="text-4xl font-playfair font-extrabold">Projects Built</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-5">
                    {projects.map((project, index) => (
                        <motion.div
                            key={index}
                            className="relative h-80 border-1 border-primary/20 overflow-hidden rounded-4xl shadow-lg shadow-primary/30"
                            initial="initial"
                            whileHover="hover"
                            whileInView="view"
                            variants={{
                            ...
                            <div className="flex flex-col border-2 border-primary/10 shadow-lg rounded-2xl">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <p className="text-xl font-bold text-muted inline-flex px-2 rounded-full">{project.title}</p>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <ul className="flex items-center bg-muted px-4 py-2 rounded-full inline-flex gap-5">
                                            <li className="font-semibold">Built using: </li>
