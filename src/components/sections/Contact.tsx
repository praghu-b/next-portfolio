...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="w-full bg-black relative">
            <Notifier message={notification.message} type={notification.type} />
            <div
                className="max-w-6xl mx-auto flex items-center justify-between md:gap-30 py-5"
            >
                <motion.div
                    className="flex-1 space-y-8 text-accent"
                ...
                >
                    <div className="space-y-5">
                        <h2 className="text-7xl font-playfair font-bold text-white">Let's Connect, <br />Work Together</h2>
                        <p className="text-lg">Have a project in mind or just want to say hi?</p>
                    </div>
                ...
                >
                    ...
                    <form className="space-y-10 py-5 text-white text-sm placeholder-white" onSubmit={handleSubmit}>
